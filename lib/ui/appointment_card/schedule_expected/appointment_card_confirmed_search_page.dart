...
class AppointmentCardConfirmedSearchDelegate extends SearchDelegate<String> {
  final List<AppointmentCard> appointmentCards;

  AppointmentCardConfirmedSearchDelegate(this.appointmentCards);
  ...
  Widget buildResults(BuildContext context) {
    ...
    return ListView.builder(
        ...
        itemBuilder: (context, index) {
          return AppointmentCardConfirmedItemCard(results[index]);
        });
  }
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    return ListView.builder(
        ...
        itemBuilder: (context, index) {
          return AppointmentCardConfirmedItemCard(suggestionList[index]);
        }
    );
  }
}